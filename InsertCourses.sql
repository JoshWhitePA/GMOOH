...
-COURSES, DESCRIPTION, AND CREDITS CAN'T BE NULL. IF ANY OTHER ATTRIBUTE SHOULD NOT BE NULL, IT SHOULD BE '1'.

EXAMPLE:
('CSC355', 'SOFTWARE ENGINEERING II', 3, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL );
...
*/
 ...
 prompt inserting data for IT major into COURSE;
	...
	insert into COURSE values
	('CSC355', 'SOFTWARE ENGINEERING II', 3 );
	...
	/*INTERNSHIPS*/
	insert into COURSE values
	('CSC280', 'COOPERATIVE INTERNSHIP I', 3, '1' );
	insert into COURSE values
	('CSC380', 'COOPERATIVE INTERNSHIP II', 3, '1' );
...
prompt inserting data for additional courses for SD major;
	...
	insert into COURSE values
	('MAT182', 'WRITING FOR WORKPLACE', 3 );/* ADJUST FOR "HIGHER THAN 181, NOT 224". SEE CHECKSHEET- COURSE LIKELY INCORRECT*/
	insert into COURSE values
	...
	-FIND A SIMPLER WAY TO INSERT GEN EDS
	-FIND A WAY TO LIST COURSES WITH SUFFIX (NOT ON CHECKSHEETS)
	*/
