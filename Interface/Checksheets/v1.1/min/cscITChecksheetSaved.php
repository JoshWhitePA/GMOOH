		...
		<!-- A. ORAL COMMUNICATION SECTION -->
				...
				<?php
					echo"<tr>
							...
							<th class = 'tableGrade' id='cr'><b></b></th>
		...
		<!-- D. CULTURAL DIVERSITY SECTION -->
				...
				<?php
					echo"<tr>
							...
							<th class = 'tableGrade'><b>3</b></th><th class = 'tableGrade' id='cr'><b></b></th>
							<th class = 'tableGrade'><b><input class = 'gradeBox' id = 'genGrade" .$indexOGen."' value='".$sData["Student"][0]["GenEd"][0]["Class"][$indexOGen]["ClassGrade"][0] . "' type = 'text' maxlength = '2' /></b></th>
				...
				// for saved checksheets dont expand for loops
					for($i = 0; $i < 11; $i++){
						echo"<tr>	
								...
								<th class = 'tableGrade'><b><input class = 'gradeBox' id = 'proGrade" .$indexOPro ."' value='".$sData["Student"][0]["Program"][0]["Class"][$indexOPro]["ClassGrade"][0] . "' type = 'text' maxlength = '2' /></b></th>
				...
				<?php
					for($i = 0; $i < 8; $i++){
						echo"<tr>	
								...
								<th class = 'tableGrade'><b><input class = 'gradeBox' id = 'proGrade" .$indexOPro ."' value='".$sData["Student"][0]["Program"][0]["Class"][$indexOPro]["ClassGrade"][0] . "' type = 'text' maxlength = '2' /></b></th>								<td class = 'tableGrade'></td>
							</tr>"; $indexOPro++;}
				?>
