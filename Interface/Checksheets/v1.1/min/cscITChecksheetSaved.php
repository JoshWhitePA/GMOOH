		...
		<!-- D. CULTURAL DIVERSITY SECTION -->
				...
				<?php
					echo"<tr>
							...
							<th class = 'tableGrade'><b></b></th><th class = 'tableGrade'><b><input class = 'gradeBox' id = 'genCR" .$indexOGen."' value = '3' /></b></th>
							<th class = 'tableGrade'><b><input class = 'gradeBox' id = 'genGrade" .$indexOGen."' value='".$sData["Student"][0]["GenEd"][0]["Class"][$indexOGen]["ClassGrade"][0] . "' type = 'text' maxlength = '2' /></b></th>
				...
				<?php
					for($i = 0; $i < 11; $i++){
						echo"<tr>	
								...
								<th class = 'tableGrade'><b><input class = 'gradeBox' id = 'proGrade" .$indexOGPro."' value='".$sData["Student"][0]["GenEd"][0]["Class"][$indexOPro]["ClassGrade"][0] . "' type = 'text' maxlength = '2' /></b></th>
