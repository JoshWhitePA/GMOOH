...
<!-- #BS CSC INFORMATION TECHNOLOGY MAJOR PROGRAM TABLE# -->
		...
		<!-- CSC IT REQUIRED COURSES SECTION -->
				...
				<?php
					for($i = 0; $i < 11; $i++)
						echo"<tr>	
								<th id = 'BS CSC:IT Required' onclick = 'findCourses(this.id)'><input class = 'courseNameBox' readonly/></th>
		...
		<!-- CSC IT ELECTIVE COURSES SECTION -->
				...
				<?php
					for($i = 0; $i < 8; $i++)
						echo"<tr>	
								<th id = 'BS CSC:IT Elective' onclick = 'findCourses(this.id)'><input class = 'courseNameBox' readonly/></th>
								<td  class = 'tableGrade'></td>
								<td  class = 'tableGrade'></td>
							</tr>";
				?>
...
<!-- CSC INFORMATION TECHNOLOGY CONCOMITANT COURSE TABLE -->
		...
		<!-- CSC IT CONCOMITANT COURSES SECTION -->
				...
				<?php
					for($i = 0; $i < 1; $i++)
						echo"<tr>	
								<th id = 'BS CSC:IT Concomitant' onclick = 'findCourses(this.id)'><input class = 'courseNameBox' readonly/></th>
								<td  class = 'tableGrade'></td>
								<td  class = 'tableGrade'></td>
							</tr>";
				?>
