				...
				$("#master").load("MasterPages/masterPage.html", function() {
					$("#mainSection")
						.append("<div id = 'two' style = 'top: 0; bottom: 0; left: 0; right: 0; margin: auto; height: 100%; position: relative'>"
							...
							+ "<tr>"
							+ "<th>Old Password &nbsp;</th>"
							+ "<td class = 'interface'><input id='oldPassword' name='oldPassword' type='password' title='Please enter your current password' pattern='[A-Za-z0-9]{8,}' required/></td>"
							+ "</tr>"
							+ "<tr>"
							+ "<th>New Password &nbsp;</th>"
							+ "<td class = 'interface'><input id='newPassword' name='newPassword' type='password' title='Please enter a new password' pattern='[A-Za-z0-9]{8,}' required/></td>"
							+ "</tr>"
							+ "<tr>"
							+ "<th>Confirm New Password &nbsp;</th>"
							+ "<td class = 'interface'><input id='confirmPassword' name='confirmPassword' type='password' title='Please confirm your new password' pattern='[A-Za-z0-9]{8,}' required/></td>"
							+ "</tr>"
							+ "<tr height = '10px'></tr>"
							+ "<tr>"
